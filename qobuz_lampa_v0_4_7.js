...
(function () {
    ...
    function AudioPlayerComponent() {
        ...
        this.pause = function () { try { audio.pause(); } catch (e) {} };
        this.stop = function () { try { audio.pause(); audio.src = ''; } catch (e) {} };
        this.back = function () { try { audio.pause(); } catch (e) {}; Lampa.Activity.backward(); };
